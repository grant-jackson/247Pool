...
GO
ALTER TABLE [dbo].[Asset] ALTER COLUMN [Colour] VARCHAR (50) NULL;

ALTER TABLE [dbo].[Asset] ALTER COLUMN [DoorPlan] VARCHAR (50) NULL;

ALTER TABLE [dbo].[Asset] ALTER COLUMN [Fuel] VARCHAR (50) NULL;

ALTER TABLE [dbo].[Asset] ALTER COLUMN [Make] VARCHAR (50) NULL;

ALTER TABLE [dbo].[Asset] ALTER COLUMN [Transmission] VARCHAR (50) NULL;
