...
INSERT INTO [dbo].[Customer]
	...
	SELECT CAST(SCOPE_IDENTITY() as int)
GO
PRINT N'Creating [dbo].[Customer_Update]...';
...
SELECT CAST(SCOPE_IDENTITY() as int)
GO
PRINT N'Creating [dbo].[EmploymentAddress_Delete]...';


GO
CREATE PROCEDURE [dbo].[EmploymentAddress_Delete]
		@Id int
AS

DELETE [dbo].[EmploymentAddress]
WHERE @Id = Id
GO
...
SELECT CAST(SCOPE_IDENTITY() as int)
GO
PRINT N'Creating [dbo].[EmploymentAddress_Update]...';


GO
CREATE PROCEDURE [dbo].[EmploymentAddress_Update]
		@Id int,
		@CustomerId int,
		@CompanyName varchar(50),
		@WorkTelephone varchar(50),
...
SELECT CAST(SCOPE_IDENTITY() as int)
GO
PRINT N'Creating [dbo].[ResidentialAddress_Delete]...';


GO
CREATE PROCEDURE [dbo].[ResidentialAddress_Delete]
		@Id INT
AS

DELETE [dbo].[ResidentialAddress]
WHERE Id = @Id
GO
...
SELECT CAST(SCOPE_IDENTITY() as int)
GO
PRINT N'Creating [dbo].[ResidentialAddress_Update]...';


GO
CREATE PROCEDURE [dbo].[ResidentialAddress_Update]
		@Id INT,
        @CustomerId int,
        @ResidentialStatusId int,
        @BuildingName varchar(50),
