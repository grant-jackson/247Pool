...
GO
ALTER TABLE [dbo].[Application] ALTER COLUMN [AgreementNo] INT NULL;
...
UPDATE [dbo].[Application]
	SET		[BrokerId] = @BrokerId
     ...
     WHERE
		Id = @Id
GO
PRINT N'Refreshing [dbo].[Application_Insert]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[Application_Insert]';
